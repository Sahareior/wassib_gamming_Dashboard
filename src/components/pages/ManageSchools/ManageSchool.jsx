...
import {FaBuilding, FaCalendar, FaChevronRight, FaEye, FaTrash, FaTimes, FaEdit} from "react-icons/fa";
import Headers from "../../Reusable/Headers.jsx";
import { FaPlus } from 'react-icons/fa6';
import ReusableModal from '../../Reusable/ReusableModal.jsx';


const SchoolCards = ({ name, type, date, status, onDelete, isSelected, onSelect, onView, onEdit }) => {
    const statusColor =
        status === "Approved"
