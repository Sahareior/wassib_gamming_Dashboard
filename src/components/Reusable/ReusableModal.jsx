...
const ReusableModal = ({
    ...
    // If view mode is enabled for manageJob, we need to handle it differently
            ...
            case 'manageJob':
                return (
                    <ManageJobFeilds
                        ...
                        job={data}
                        view={view}
                        onClose={onClose} // Pass onClose to ManageJobFeilds
                    />
                );
            case 'manageSchool':
                return (
    ...
    // For view mode, we might want to hide the form submission buttons
    const showButtons = !(location === 'manageJob' && view);

    return (
        <div className="fixed  inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div
  className={`bg-white rounded-lg   ${
    view || location==='portfolio' ? "w-[60vw] p-8" : "max-w-md w-full p-6 mx-4"
  }`}
>
